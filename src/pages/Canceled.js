...
import iconGiphy from '../assets/images/giphy.gif';

const Canceled = () => {
  return (
    <div className='w-full pt-[25px] bg-slate-100 h-full min-h-[72vh] flex flex-col justify-center items-center pt-10 px-2  md:p-10'>
      <div className='bg-slate-100 w-full  text-center flex justify-center items-center flex-col rounded'>
        <div className=''>
          <img src={iconGiphy} className='h-[350px]' alt='error' />
        </div>
        <h1 className='text-red-600 font-bold text-[28px] py-3 '>
          payment Cancel
        </h1>
      </div>
